...
async fn run() {
    ...
    let app = Router::new()
        ...
        .route("/git/apply", post(git::apply_patch))
        ...
        .route("/git/branch", post(git::branch))
        .route("/git/branch/delete", post(git::branch_delete))
        .route("/git/tag", post(git::tag))
        .route("/git/tag/delete", post(git::tag_delete))
        .route("/git/merge", post(git::merge))
